...
var (
	filter_Query_OperatorDelegations_0 = &utilities.DoubleArray{Encoding: map[string]int{"operator_address": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
var (
	filter_Query_OperatorUnbondingDelegations_0 = &utilities.DoubleArray{Encoding: map[string]int{"operator_address": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
var (
	filter_Query_DelegatorOperators_0 = &utilities.DoubleArray{Encoding: map[string]int{"delegator_addr": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
var (
	pattern_Query_Operators_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"restaking_protocol", "v1", "operators"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Operator_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"restaking_protocol", "v1", "operators", "operator_address"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_OperatorDelegations_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"restaking_protocol", "v1", "operators", "operator_address", "delegations"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_OperatorUnbondingDelegations_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"restaking_protocol", "v1", "operators", "operator_address", "unbonding_delegations"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Delegation_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"restaking_protocol", "v1", "operators", "operator_address", "delegations", "delegator_address"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_UnbondingDelegation_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4, 1, 0, 4, 1, 5, 5, 2, 6}, []string{"restaking", "v1", "operators", "operator_address", "delegations", "delegator_address", "unbonding_delegation"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_DelegatorDelegations_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"restaking", "v1", "delegations", "delegator_addr"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_DelegatorUnbondingDelegations_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"restaking", "v1", "delegators", "delegator_addr", "unbonding_delegations"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_DelegatorOperators_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"restaking", "v1", "delegators", "delegator_addr", "operators"}, "", runtime.AssumeColonVerbOpt(true)))
)
