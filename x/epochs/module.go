...
import (
	...
	"github.com/celinium-network/restaking_protocol/x/epochs/client/cli"
	"github.com/celinium-network/restaking_protocol/x/epochs/keeper"
...
func (AppModuleBasic) DefaultGenesis(cdc codec.JSONCodec) json.RawMessage {
	return cdc.MustMarshalJSON(types.ProductionGenesisState())
}
