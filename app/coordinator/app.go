...
type App struct {
	*baseapp.BaseApp
	...
	RestakingCoordinatorKeeper coordinatorkeeper.Keeper
...
func New(
	...
	scopedRestakingCoordinatorKeeper := app.CapabilityKeeper.ScopeToModule(coordinatortypes.ModuleName)
	...
	*/
	...
	coordinatorIBCModule := coordinator.NewAppModule(appCodec, app.RestakingCoordinatorKeeper)
	...
	govRouter.
		...
		AddRoute(coordinatortypes.RouterKey, coordinator.NewProviderProposalHandler(app.RestakingCoordinatorKeeper))
