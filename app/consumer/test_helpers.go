...
func setup(withGenesis bool, invCheckPeriod uint) (*App, GenesisState) {
	...
	app := New(log.NewNopLogger(), db, nil, true, map[int64]bool{}, DefaultNodeHome, invCheckPeriod, encCdc, appOptions)
	if withGenesis {
...
func NewSimappWithCustomOptions(t *testing.T, isCheckTx bool, options SetupOptions) *App {
	...
	app := New(log.NewNopLogger(), options.DB, nil, true, map[int64]bool{}, DefaultNodeHome, options.InvCheckPeriod, options.EncConfig, options.AppOpts)
