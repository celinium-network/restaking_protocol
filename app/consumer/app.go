...
import (
	...
	epochs "github.com/celinium-network/restaking_protocol/x/epochs"
	...
	consumertypes "github.com/celinium-network/restaking_protocol/x/restaking/consumer/types"
)
...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		...
		epochstypes.StoreKey, multistakingtypes.StoreKey, consumertypes.StoreKey,
	)
	...
	scopedRestakingConsumerKeeper := app.CapabilityKeeper.ScopeToModule(consumertypes.ModuleName)
	...
	*/
	...
	govRouter.
		...
		AddRoute(multistakingtypes.RouterKey, multistaking.NewProviderProposalHandler(app.MTStakingKeeper))
	...
	ibcRouter.AddRoute(icahosttypes.SubModuleName, icaHostIBCModule).
		...
		AddRoute(consumertypes.ModuleName, restakingConsumerIBCModule)
